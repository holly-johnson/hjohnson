...
/**
 * Small inline-SVG icon set (lucide paths) so the portfolio needs no icon
 * dependency. Add a case here when a new lucide glyph is needed.
 * Usage: <app-icon name="mail" [size]="14" />
 */
@Component({
  selector: 'app-icon',
  template: `
