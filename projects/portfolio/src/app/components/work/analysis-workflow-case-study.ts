...
export class AnalysisWorkflowCaseStudy {
  ...
  protected readonly findings = [
    ...
    { title: 'The work must remain understandable', detail: 'The final record needs to preserve enough context for another person to understand how the findings were reached. It has to hold for the same investigator years later.' },
  ];
