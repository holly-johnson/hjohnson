  ...
  protected readonly sections: AboutSection[] = [
    {
      ...
      body: [
        ...
        'Then in 2011 the agency redesigned its public website, and that redesign redirected everything. Design and code arrived together rather than in sequence, which is why the titles that followed usually carried both words.',
    ...
    },
    {
      ...
      heading: 'How I work',
      body: [
        'Designer and developer, both, from the start. Design decisions get tested against the code that has to carry them, and the handoff is short because there is less to hand off.',
